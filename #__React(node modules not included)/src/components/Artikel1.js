...
<div class="d-flex justify-content-center">
	<div class="col-md-8 title article">
		<div class="bookLogo">
			...
			<h2 class="inline">Apakah benar puasa dapat menhilangkan racun-racun pada tubuh?</h2>
		</div>
	</div>
</div>,
...
<div class="d-flex justify-content-center imagecont">
		<div class="col-md-8 image">
			<img src="../../assets/Articles/Artikel1.jpg" />
		</div>
</div>,
...
<div class="d-flex justify-content-center">
	<div class="col-md-8 contArticle">
		<div class="d-flex justify-content-center">
			Beberapa mitos sering terdengar tentang puasa dan kemungkinan gangguan yang mempengaruhi kesehatan. Puasa dapat menurunkan berat badan adalah salah satu mitos yang sering kali dipercaya oleh masyarakat. Orang yang memiliki penyakit tertentu dan mengharuskan konsumsi obat secara rutin sering kali bingung tentang cara menjalankan puasa dan tetap dapat minum obat. Berikut beberapa penjelasan tentang mitos atau pertanyaan yang timbul saat akan memasuki bulan ramadan.<br /><br />
		    Bolehkah penderita diabetes menjalankan puasa? <br />
		    Umumnya penderita diabetes tipe 1 tidak dapat menjalankan puasa, sedangkan penderita diabetes tipe 2 yang menggunakan insulin dapat menjalankan puasa. Namun, perlu untuk berkonsultasi dengan dokter terlebih dahulu agar dapat dilakukan penyesuaian dosis dan jenis insulin.
		    Puasa dapat menyebabkan migrain parah.<br />
		    Orang yang mudah mengalami migrain ketika tidak mengkonsumsi makanan dapat menjalankan puasa. Berkonsultasilah terlebih dahulu dengan dokter untuk terapi pengobatan yang tepat dan perubahan gaya hidup tertentu. <br /><br />
		    Dapatkah penderita tekanan darah tinggi atau rendah menjalankan puasa? <br />
		    Penderita tekanan darah tinggi yang terkontrol atau sudah stabil normal dapat menjalankan puasa. Berkonsultasilah terlebih dahulu dengan dokter agar dapat diberikan obat sehingga tekanan darah dapat tetap terkontrol selama puasa.  Bagi penderita tekanan darah rendah, dapat menjalankan puasa dengan memenuhi kebutuhan cairan dan elektrolit saat sedang berbuka hingga sahur. <br /><br />
		    Apakah wanita yang sedang hamil dapat berpuasa? <br />
		    Jika seorang wanita hamil memiliki kondisi yang sehat maka dapat berpuasa. Berkonsultasilah dengan dokter sebelum melakukan puasa, terutama pada bagian awal kehamilan. <br /><br />
		    Puasa dapat menurunkan berat badan <br />
		    Puasa memang dapat menurunkan berat badan, namun bukan merupakan cara yang efektif untuk menurunkan berat badan. Salah satu penelitian menunjukkan bahwa berpuasa setiap hari selama 22 hari tidak menyebabkan penurunan tingkat metabolisme, tetapi dapat terjadi penurunan massa lemak hingga 4%.<br /><br />
		    Puasa dapat menghilangkan racun dari tubuh <br />
		    Tidak ada bukti ilmiah yang menunjukkan bahwa puasa dapat membersihkan tubuh dari zat yang berbahaya. Tubuh sudah memiliki organ yang mampu untuk mengeluarkan racun, seperti ginjal, hati, paru-paru, usus besar dan kulit. <br /><br />
		    Bagaimana tetap sehat selama berpuasa? <br /><br />
		    Asupan air yang cukup yaitu sekitar 8-10 gelas sehari. Bagi para lansia (lanjut usia) seringkali tidak merasa haus walau baru minum sedikit. Namun demi kesehatan, hendaknya diusahakan untuk minum yang cukup meski tidak haus. Minum air di sini tidak selalu berarti air putih semata, tetapi minum teh, susu, jus buah, koktil buah, bahkan kuah sayur juga termasuk dalam jumlah air yang kita konsumsi.
